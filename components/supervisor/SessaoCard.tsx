...
export function SessaoCard({ sessao }: { sessao: SessaoComCount }) {
  ...
  return (
    <Link
      ...
      className="block rounded-lg border p-5 space-y-3 transition-colors hover:border-primary/30 group"
